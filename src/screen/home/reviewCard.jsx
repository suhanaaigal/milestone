        ...
        <div className="p-4 lg:w-1/3">
            <div className="h-full bg-gray-200 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
              <h2 className="tracking-widest text-xs title-font font-medium text-gray-500 mb-1">CATEGORY</h2>
                <h1 className="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">{props.user.name}</h1>
                <p className="leading-relaxed mb-3">{props.user.content}</p>
